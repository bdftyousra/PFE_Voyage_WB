...
{
    try {
        $req = "INSERT INTO voyage (villedepart, villearriver, datedepart, datearriver, heuredepart, heurearrive, capacite, outile, prix) 
                VALUES (:vd, :va, :dd, :da, :hd, :ha, :c, :o, :p)";
        ...
        $result = DataAccess::prepareAndExecute($req, $params);

        if ($result) {
            echo "Travel added successfully!";
        } else {
            echo "Error adding travel!";
        }
